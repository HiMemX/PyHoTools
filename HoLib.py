import Static.MAST as MAST
import Helpers.WideString as WideString
import time
import datetime
import Static.Asset as Asset
import Helpers.MoreMath as MoreMath
...
if False:#if __name__ == "__main__":
    start = time.time()
    test = hkOArchive(r"C:\Users\felix\Desktop\Research hoes\SHUB -do not edit.ho - Kopie (6).ho")
    created = time.time()
    test.Update()
    updated = time.time()
    test.Save()
